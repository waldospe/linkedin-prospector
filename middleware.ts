...
export async function middleware(request: Request) {
  ...
  if (url.pathname === '/login' || url.pathname.startsWith('/invite/') || url.pathname.startsWith('/api/invite/') || url.pathname === '/api/auth' || url.pathname === '/api/auth/check' || url.pathname === '/api/auth/signup' || url.pathname === '/api/auth/forgot-password' || url.pathname.startsWith('/reset-password/') || url.pathname === '/api/teams' || url.pathname === '/api/queue/auto-process' || url.pathname === '/api/contacts/backfill-avatars' || url.pathname === '/api/digest/send' || url.pathname === '/api/unipile/callback' || url.pathname === '/api/billing/webhook' || url.pathname === '/api/health') {
